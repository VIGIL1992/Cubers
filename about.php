    ...
    <div id="smooth-wrapper">
        ...
        <div id="smooth-content">
            ...
            <main class="main-bg">
                        ...
                        <div class="row">
                            <div class="col-lg-5 valign">
                                <div class="content md-mb50">
                                    <h6 class="sub-title main-color mb-15">About Company</h6>
                                    <h3 class="fw-600 mb-30">Design & Development, <span
                                            class="fw-300">Optimization</span> Agency</h3>
                                    <p>Whether you are a development agency looking to outsource design work, a company
                                        in search of a Product Designer or Product Team, a marketing agency that needs.
                                    </p>
                                    <a href="contact.php" class="butn butn-md butn-bord radius-30 mt-40">
                                        ...
                                        <div class="col-md-6">
                                            <div class="item-box radius-15 sm-mb30">
                                                ...
                                                <p>Live workshop where we define the main problems and challenges before
                                                    building.</p>
                                                <a href="services.php" class="rmore mt-30">
                ...
                <section class="page-intro-modern section-padding pt-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="img2 fit-img position-re o-hidden">
                                            <img src="assets/imgs/intro/2.jpg" alt="" data-speed="0.2" data-lag="0">
                                        </div>
                                    </div>
                    ...
                    <div class="container mt-100">
                        <div class="row justify-content-around">
                            <div class="col-lg-5">
                                <div class="cont">
                                    <h4>If you’re looking for a specialist to build a meaningful digital project you can
                                        easily reach us by clicking <span class="underline"><a href="#0"
                                                class="main-color">here</a></span></h4>
                                    <div class="exp mt-80 md-mb15">
                                        <h2 class="fz-70">12 <span class="sub-title main-font opacity-7 ml-15">Years
                            ...
                            <div class="col-lg-5 valign">
                                <div class="full-width">
                                    <div class="text">
                                        <p>Whether you are a development agency looking to outsource design work, a
                                    ...
                                    <div class="col-md-5 rest">
                                        <div class="cont">
                                            ...
                                            <div class="text mt-30">
                                                <p>Our journey is defined by a rich tapestry of achievements and values that set us apart.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5 rest">
                        ...
                        <div class="sec-head pb-30 pt-20 bord-thin-bottom">
                            <div class="main-marq xlrg o-hidden">
                                <div class="slide-har st1">
                                    <div class="box">
                                        <div class="item">
                                            <h4 class="d-flex align-items-center"><span>Meet Our Team</span>
                            ...
                            <div class="col-lg-5 rest">
                                <div class="glry-img">
                                    <div id="tab-1" class="bg-img tab-img current"
                                        data-background="assets/imgs/team/1.jpg"></div>
                                    <div id="tab-2" class="bg-img tab-img" data-background="assets/imgs/team/2.jpg">
                                    </div>
                                    <div id="tab-3" class="bg-img tab-img" data-background="assets/imgs/team/3.jpg">
                                    </div>
                                    <div id="tab-4" class="bg-img tab-img" data-background="assets/imgs/team/4.jpg">
                                    </div>
                                    <div id="tab-5" class="bg-img tab-img" data-background="assets/imgs/team/3.jpg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7 rest content">
                                <div class="cluom current" data-tab="tab-1">
                                    ...
                                    <div class="more text-u ls1 fz-12">
                                        <a href="page-team-single.html">View More <i class="ml-15 ti-arrow-top-right"></i></a>
                                    </div>
                                </div>
                ...
                <section class="brands-crev simple section-padding">
                    <div class="container">
                        <div class="row">
