 ...
 <footer class="clean-footer crev bg-img" data-background="assets/imgs/header/bg1.jpg" data-overlay-dark="10">
     <div class="container pb-40 section-padding ontop">
         <div class="cal-action pb-50 mb-80 bord-thin-bottom">
             <h2 class="fz-120 line-height-1 d-rotate wow">
                 <span class="rotate-text"><a href="contact.php">Let’s Contact <span class="ml-30 fz-70 ti-arrow-top-right"></span></a></span>
             </h2>
         </div>
         <div class="row">
             <div class="col-lg-3">
             ...
             <div class="col-lg-4">
                 <div class="column">
                     <div class="mb-40">
                         ...
                         <h5 class="opacity-8">2nd Floor,Mangalya Complex MPC Junction, Koduvally, Kerala 673572</h5>
                     </div>

                     <a href="#0" class="underline">
                         <span class="fz-22 main-color">+91 012 345 67 89</span>
                     </a>
                 </div>
             </div>
